  ...
  return (
    <div className="flex flex-col min-h-screen pb-24 md:pb-0 brand-gradient-soft">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 md:py-4 flex flex-wrap justify-between items-center gap-2">
          ...
          <div className="flex items-center gap-2 md:gap-3 shrink-0">
            ...
            <button
              ...
              className={`w-8 h-8 md:w-9 md:h-9 flex items-center justify-center rounded-full border text-sm md:text-base hover:bg-gray-50 ${i18n.language && i18n.language.startsWith('en') ? 'ring-2 ring-[#ac7031]' : ''}`}
            >
            ...
            <button
              ...
              className={`w-8 h-8 md:w-9 md:h-9 flex items-center justify-center rounded-full border text-sm md:text-base hover:bg-gray-50 ${i18n.language && i18n.language.startsWith('de') ? 'ring-2 ring-[#ac7031]' : ''}`}
            >
      ...
      {/* Footer copied from Landing */}
        ...
        <div className="border-t border-[#e7aa51] mt-8 py-4 text-center text-sm text-gray-500">
