...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center py-1 px-4 brand-gradient-soft rounded-2xl">
      <div className="w-full max-w-2xl">
        ...
        {selectedWorker ? (
          <div className="mb-6 rounded-2xl border border-[#e7aa51] bg-[#fff7e2] p-5 text-center shadow-sm">
            <p className="text-sm font-semibold uppercase tracking-wide text-[#8d5a1b]">
            ...
            <Link
              to="/profile"
              className="mt-4 inline-flex items-center justify-center rounded-full border border-[#ac7031] px-4 py-2 text-sm font-semibold text-[#8d5a1b] hover:bg-[#ffe499] transition"
            >
          ...
          <div className="mb-6 rounded-2xl border border-dashed border-gray-300 p-5 text-center">
            ...
            <Link
              to="/profile"
              className="mt-3 inline-flex items-center justify-center rounded-full brand-btn px-4 py-2 text-sm font-semibold text-white shadow-md hover:shadow-lg transition"
            >
        ...
        >
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-center justify-center p-5 rounded-xl border transition-shadow ${
                      selected
                        ? "bg-[#ffe499] shadow-lg border-[#e7aa51]"
          ...
          <div className="relative overflow-hidden rounded-2xl p-[1px] bg-gradient-to-r from-[#ffe499] via-[#e7aa51] to-[#8d5a1b] shadow-lg">
            <div className="rounded-2xl bg-gradient-to-br from-[#ecfeff] via-white to-[#e0f7f7] px-4 py-5 sm:px-6 sm:py-6">
              <p className="text-xs sm:text-sm font-semibold uppercase tracking-wide text-[#8d5a1b]">
                {t("home.estimated")}
              </p>
          ...
          <div className="relative">
            ...
            >
              <div className="p-[2px] rounded-2xl bg-gradient-to-r from-[#ffe499] via-[#e7aa51] to-[#ac7031] shadow-lg transition-transform duration-200 group-hover:-translate-y-0.5 focus-visible:ring-2 focus-visible:ring-[#e7aa51]/50">
                    ...
                    return (
                      <div className="flex flex-col items-center max-w-[34rem] mx-auto">
                        <div className="my-4 flex justify-center">
                          <Gift
                            className="h-24 sm:h-28 md:h-36 w-24 sm:w-28 md:w-36 text-[#ac7031] animate-bounce drop-shadow-lg"
                            strokeWidth={2.5}
                          />
                        </div>
